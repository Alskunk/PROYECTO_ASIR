...
<html>
        ...
        <header>
                ...
                <section class="container">
                        <?php
                            $consulta = "SELECT usuario_id, Nombre, Primer_apellido FROM USUARIOS WHERE glucosa = 'si'";
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>"; 
                            echo "<a href=registroglucosa.php?usuario_id=".$fila['usuario_id'].">".$fila['usuario_id']."</a>";
                        echo "</td>";
                        echo "<td>"; 
                            echo $fila['Nombre'];
                        echo "</td>";
