...
<html>
        ...
        <body>
                ...
                <section class="container">
                    <form method="POST" action="baja_pa.php">
                        <fieldset>
                                <div class="formulario">
                                Selecciona la ID de la prescripción:&nbsp;&nbsp; <input type="text" name="id"/> &nbsp;&nbsp;
                                
                                Fecha de fin de pauta:&nbsp;&nbsp; <input type="date" name="fecha" placeholder="AAAA-MM-DD"/> &nbsp;&nbsp;
                ...
                and U.Primer_apellido = '$apellido1' and P.FECHA_FIN is NULL";
