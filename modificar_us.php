...
<html>
 ...
 <section class="container">
        <?php
            ...
            $modificar="UPDATE USUARIOS SET telefono='$telefono', centro='$centro', alergias='$alergias', paracetamol='$paracetamol', Email='$email', glucosa='$glucosa'
            where DNI='$DNI'";
            $datos = mysqli_query($conexion, $modificar);
