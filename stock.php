...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="registrostock.php" target="contenido">Registro stock</a>
                        </div>
                        <div class="columna2">
                                <a href="stockmedicacion.php" target="contenido">Stock medicación</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="eliminarstock.php" target="contenido">Eliminar stock</a>
                        </div>
