...
<html>
        ...
        <body>
               ...
               <section class="container">
                <form method="POST" action="verregistro_u.php">
                                <fieldset>
                                        <div class="formulario">
                                Filtrar:&nbsp;&nbsp; Fecha:&nbsp;&nbsp; <input type="date" name="fecha"/> &nbsp;&nbsp;
                ...
                LEFT JOIN REGISTROS_MEDICACION R ON R.PRESCRIPCION_ID =  P.PRESCRIPCION_ID WHERE R.FECHA_ADMINISTRAR IS NOT NULL
