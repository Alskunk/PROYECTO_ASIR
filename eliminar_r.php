...
<html>
        ...
        <body>
               ...
               <section class="container">
                ...
                $consulta2 = "SELECT U.Nombre, U.Primer_apellido, R.FECHA_ADMINISTRAR, R.TOMA, R.OBSERVACIONES, R.registros_id, P.TURNO, M.Medicamento
                FROM USUARIOS U
                ...
                echo "<tr>";
                        echo "<td>"; 
                            echo "<a href=eliminar_re.php?registros_id=".$fila2['registros_id'].">".$fila2['registros_id']."</a>";
                        echo "</td>";
                        echo "<td>"; 
                                echo $fila2['Nombre'];
                        echo "</td>";
