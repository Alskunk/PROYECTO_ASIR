...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="usuarios.php" target="contenido">USUARIOS</a>
                        </div>
                        <div class="columna2">
                                <a href="m_esporadica.php" target="contenido">ESPORÁDICA</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="glucosa.php" target="contenido">GLUCOSA</a>
                        </div>
                        <div class="columna4">
                                <a href="pautas.php" target="contenido">PAUTAS</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna5">
                                <a href="stock.php" target="contenido">STOCK</a>
                        </div>
                        <div class="columna6">
                                <a href="registros.php" target="contenido">REGISTROS</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna7">
                                <a href="pedidos.php" target="contenido">PEDIDOS</a>
                        </div>
