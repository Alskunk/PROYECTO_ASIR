...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="pauta_u.php" target="contenido">Insertar pauta</a>
                        </div>
                        <div class="columna2">
                                <a href="verpauta.php" target="contenido">Ver pauta</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="bajapauta.php" target="contenido">Baja pauta</a>
                        </div>
                        <div class="columna5">
                                <a href="verbajapauta.php" target="contenido">Ver pauta de baja</a>
                        </div>
                </div>
