...
<html>
        ...
        <body>
               ...
               <section class="container">
                       ...
                       <form method="POST" action="registro_stock.php">
                                <fieldset>
                                <div class="formulario">
                                Selecciona la ID del medicamento:&nbsp;&nbsp; <input type="text" name="id"/> &nbsp;&nbsp;
                                
                                Indica la cantidad a añadir:&nbsp;&nbsp; <input type="text" name="stock" /> &nbsp;&nbsp;
                ...
                and U.Primer_apellido = '$apellido1' and M.activo is NULL";
