...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="glucosa_usuarios.php" target="contenido">Insertar glucosa</a>
                        </div>
                        <div class="columna2">
                                <a href="verglucosa_u.php" target="contenido">Ver glucosa usuario</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="verregistroglucosa.php" target="contenido">Ver glucosa</a>
                        </div>
                        <div class="columna4">
                                <a href="eliminarglucosa.php" target="contenido">Eliminar glucosa</a>
                        </div>
                </div>
