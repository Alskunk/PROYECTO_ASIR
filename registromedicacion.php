...
<html>
        ...
        <body>
               ...
               <section class="container">
                <?php
                        ...
                        $consulta2 = "SELECT U.Nombre, U.Primer_apellido, P.PRESCRIPCION_ID, P.usuario_id, P.FECHA_INICIO, P.CANTIDAD_PRES, P.TURNO, 
                        ...
                        WHERE P.FECHA_FIN is NULL and P.PRESCRIPCION_ID IS NOT NULL ORDER BY U.Nombre asc";
        ...
        echo "<tr>";
            ...
            echo "<td>"; 
                echo "<a href=registro_m.php?PRESCRIPCION_ID=".$fila2['PRESCRIPCION_ID'].">".$fila2['PRESCRIPCION_ID']."</a>";
            echo "</td>";
            echo "<td>"; 
                echo $fila2['Nombre'];
            echo "</td>";
