...
<html>
        <head>
                ...
                <title>Medicacion esporadica</title>
        </head>
        <body>
              <header>
                        <nav>
                ...
                <section class='container'>
                        <form method="POST" action="insertar_esporadica.php">
                                ...
                                Fecha de inicio:<br/> <input type="date" name="f_inicio" placeholder="AAAA-MM-DD"/> <br/><br/>
                                Fecha de fin:<br/> <input type="date" name="f_fin" placeholder="AAAA-MM-DD"/> <br/><br/>
                                Cantidad:<br/> <input type="text" name="cantidad" placeholder="Cantidad"/> <br/><br/>
                                Hora:<br/> <input type="time" name="hora" placeholder="HH:MM"/> <br/><br/>
                                Observaciones:<br/><br/>
