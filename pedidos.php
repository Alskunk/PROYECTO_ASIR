...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="hacerpedido.php" target="contenido">Hacer pedido</a>
                        </div>
                        <div class="columna2">
                                <a href="pedidousuario.php" target="contenido">Ver pedido usuario</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="receppedido.php" target="contenido">Recepción pedido</a>
                        </div>
                        <div class="columna4">
                                <a href="pedidorecepcionado.php" target="contenido">Ver pedido recepcionado</a>
                        </div>
                </div>
