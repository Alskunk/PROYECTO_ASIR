...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="insertar_usuario.php" target="contenido">Insertar usuario</a>
                        </div>
                        <div class="columna2">
                                <a href="ver_u.php" target="contenido">Datos usuario</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="borrarusuario.php" target="contenido">Borrar usuario</a>
                        </div>
                        <div class="columna4">
                                <a href="modificarusuario.php" target="contenido">Modificar usuario</a>
                        </div>
                </div>
