...
<html>
        ...
        <body>
               ...
               <section class="container">
                 ...
                 <form method="POST" action="esporadicaporfechausuario.php">
                                <fieldset>
                                <div class="formulario">
                                Nombre:&nbsp;&nbsp; <input type="text" name="nombre" value="<?php echo $nombre?>"/> &nbsp;&nbsp;
                                Primer apellido:&nbsp;&nbsp; <input type="text" name="primer_apellido" value="<?php echo $apellido1?>"/> &nbsp;&nbsp;
                                Fecha de inicio:&nbsp;&nbsp; <input type="date" name="f_inicio" placeholder="AAAA-MM-DD"/> &nbsp;&nbsp;
                                Fecha de fin:&nbsp;&nbsp; <input type="date" name="f_fin" placeholder="AAAA-MM-DD"/> &nbsp;&nbsp;
                ...
                $consulta2 = "SELECT U.Nombre, U.Primer_apellido, E.esporadica_id, E.usuario_id, E.fecha_inicio, E.fecha_fin, E.medicamento, E.hora, E.cantidad, E.observaciones 
                FROM USUARIOS U JOIN MEDICACION_ESPORADICA E ON U.usuario_id = E.usuario_id WHERE U.Nombre = '$nombre' and U.Primer_apellido = '$apellido1'"; 
