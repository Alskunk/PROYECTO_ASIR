...
<html>
        ...
        <body>
            ...
            $insertar="UPDATE PRESCRIPCIONES SET FECHA_FIN='$fecha' where PRESCRIPCION_ID='$id' ";
            $datos = mysqli_query($conexion, $insertar);
                if (mysqli_errno($conexion)==0){
                echo "<div class='bloque1'>";
                echo "<div class='contenedor1'>";       
                echo("PAUTA DADA DE BAJA");
                echo "</div>";
                echo "</div>";
                        $consulta2="SELECT * FROM PRESCRIPCIONES where PRESCRIPCION_ID='$id' ";
                        $datos2 = mysqli_query($conexion, $consulta2);
                        $fila = mysqli_fetch_assoc($datos2);
                        $medicamento_id = $fila['medicacion_id'];
                        $modificar = "UPDATE MEDICAMENTO SET activo='no' WHERE medicacion_id = '$medicamento_id'";
                        $datos3 = mysqli_query($conexion, $modificar);
                        echo "<div class='bloque1'>";
                        echo "<div class='contenedor1'>";       
                        echo("MEDICACIÓN DADA DE BAJA ");
                        echo "</div>";
                        echo "</div>";               
                }
