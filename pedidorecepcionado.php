...
<html>
        <head>
                ...
                <title>pedidosrecepcionados</title>
        </head>
        <body>
                <header>
                        <nav>
                ...
                <section class="container">
                        <form method="POST" action="pedidorecepcionado_u.php">
                                <fieldset>
                                        <div class="formulario">
                                Filtrar:&nbsp;&nbsp; Nombre:&nbsp;&nbsp; <input type="text" name="nombre"/> &nbsp;&nbsp;
                                Primer apellido:&nbsp;&nbsp;<input type="text" name="p_apellido" /> &nbsp;&nbsp;
