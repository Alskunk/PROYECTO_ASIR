...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="esporadica_usuarios.php" target="contenido">Insertar esporádica</a>
                        </div>
                        <div class="columna2">
                                <a href="veresporadica.php" target="contenido">Esporádica usuario</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="todaesporadica.php" target="contenido">Ver esporádica</a>
                        </div>
                        <div class="columna5">
                                <a href="eliminaresporadica.php" target="contenido">Eliminar esporádica</a>
                        </div>
                </div>
