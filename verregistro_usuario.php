...
<html>
        ...
        <body>
                ...
                <form method="POST" action="ver_mensual.php">
                                <fieldset>
                                        <div class="formulario">
                                Nombre:&nbsp; <input type="text" name="nombre" value="<?php echo $nombre?>"/> &nbsp;
                                Primer apellido:&nbsp; <input type="text" name="primer_apellido" value="<?php echo $apellido?>"/>&nbsp; 
                                Fecha inicio:&nbsp;&nbsp; <input type="date" name="fechai"/> &nbsp;
                                Fecha fin:&nbsp;&nbsp; <input type="date" name="fechaf"/> &nbsp;
                ...
                LEFT JOIN REGISTROS_MEDICACION R ON R.PRESCRIPCION_ID =  P.PRESCRIPCION_ID WHERE U.usuario_id = '$ID' AND R.FECHA_ADMINISTRAR IS NOT NULL 
