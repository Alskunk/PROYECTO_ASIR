...
<html>
        ...
        <body>
               ...
               <section class="container">
                ...
                $consulta2 = "SELECT U.Nombre, U.Primer_apellido, M.Medicamento, M.stock, P.pedidos_id, P.medicacion_id, P.fecha_pedido 
                FROM PEDIDOS P
                LEFT JOIN MEDICAMENTO M ON M.medicacion_id =  P.medicacion_id
                LEFT JOIN USUARIOS U ON U.usuario_id =  P.usuario_id
                where P.fecha_recepcion is NULL "; 
                ...
                echo "<tr>";
                        echo "<td>"; 
                            echo "<a href=recep_p.php?pedidos_id=".$fila2['pedidos_id'].">".$fila2['pedidos_id']."</a>";
                        echo "</td>";
                        echo "<td>"; 
