        ...
        <body>
         <header>
                ...
                <section class="container">
                        <?php
                            $consulta = "SELECT usuario_id, Nombre, Primer_apellido FROM USUARIOS ORDER BY Nombre asc";
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>"; 
                            echo "<a href=verregistro_usuario.php?usuario_id=".$fila['usuario_id'].">".$fila['usuario_id']."</a>";
                        echo "</td>";
                        echo "<td>"; 
                            echo $fila['Nombre'];
                        echo "</td>";
