...
<html>
        <head>
                ...
                <title>Medicacion esporadica usuario</title>
        </head>
        <body>
                <header>
                        <nav>
				 ...
				 <section class="container">
                        <?php
                            $consulta = "SELECT usuario_id, Nombre, Primer_apellido FROM USUARIOS";
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>"; 
                            echo "<a href=ver_espo.php?usuario_id=".$fila['usuario_id'].">".$fila['usuario_id']."</a>";
                        echo "</td>";
                        echo "<td>"; 
                            echo $fila['Nombre'];
                        echo "</td>";
