...
<html>
        ...
        <header>
                ...
                <section class="container">
                                <form method="POST" action="e_stock.php">
                                        <fieldset>
                                        <div class="formulario">
                                    Indica la ID del medicamento:&nbsp;&nbsp; <input type="text" name="id"/> &nbsp;&nbsp;
                ...
                <?php
                        ...
                        FROM USUARIOS U JOIN MEDICAMENTO M ON M.usuario_id = U.usuario_id where M.activo is not NULL ORDER BY U.Nombre ASC";
