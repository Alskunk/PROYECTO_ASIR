...
<html>
        ...
        <body>
                ...
                <div class="contenedor1">
                        <div class="columna1">
                                <a href="registromedicacion.php" target="contenido">Insertar registro</a>
                        </div>
                        <div class="columna2">
                                <a href="verregistro_f.php" target="contenido">Ver registro</a>
                        </div>
                </div>
                <div class="contenedor1">
                        <div class="columna3">
                                <a href="verregistro.php" target="contenido">Registro mensual</a>
                        </div>
                        <div class="columna4">
                                <a href="eliminar.php" target="contenido">Eliminar registro</a>
                        </div>
