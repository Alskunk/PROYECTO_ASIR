...
<html>
        ...
        <body>
               ...
               <section class="container">
                ...
                <form method="POST" action="esporadicaporfecha.php">
                <fieldset> 
                ...
                $consulta2 = "SELECT U.Nombre, U.Primer_apellido, E.esporadica_id, E.usuario_id, 
                E.fecha_inicio, E.fecha_fin, E.medicamento, E.hora, E.cantidad, E.observaciones 
                FROM USUARIOS U, MEDICACION_ESPORADICA E where U.usuario_id = E.usuario_id "; 
